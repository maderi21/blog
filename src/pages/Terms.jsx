const Terms = () => {
  return (
    <div className="container mt-5 pt-5">
      ...
      <p>Welcome to maderi!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Maderi's Website, located at https://maderi.co.uk/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use maderi if you do not agree to take
      ...
      <p>
        ...
        subject to, prevailing law of sk. Any use of the above terminology or
      ...
      <p>
        We employ the use of cookies. By accessing maderi, you agreed to use
        cookies in agreement with the Maderi's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Maderi and/or its licensors own the
        intellectual property rights for all material on maderi. All
        intellectual property rights are reserved. You may access this from
        maderi for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from maderi</li>
        <li>Sell, rent or sub-license material from maderi</li>
        <li>Reproduce, duplicate or copy material from maderi</li>
        <li>Redistribute content from maderi</li>
      </ul>
      ...
      <p>
        ...
        Maderi does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of Maderi,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, Maderi shall not be liable for the
      ...
      <p>
        Maderi reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Maderi a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of Maderi; and (d) the link is in
      ...
      <p>
        ...
        e-mail to Maderi. Please include your name, your organization name,
      ...
      <p>
        No use of Maderi's logo or other artwork will be allowed for linking
